...
def _get_sites(site_rows, site_id_in_excel_2_spare_sites_str):
    """
    函数说明: 生成网址列表
    ...
    for site_row in site_rows:
        ...
        spare_sites_str = site_id_in_excel_2_spare_sites_str.get(site_id_in_excel, "")
        # 1.6 添加网址
...
def generate_sites_from_excel_data(data):
    ...
    site_id_in_excel_2_spare_sites_str = _get_site_id_in_excel_2_spare_sites_str(spare_site_rows)
    # 3. 生成网址列表
    sites = _get_sites(site_rows, site_id_in_excel_2_spare_sites_str)
    # 检查生成的网址数据
    # for site in sites:
    #     print(site.__dict__)
    # 4. 返回
